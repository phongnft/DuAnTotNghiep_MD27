...
public class Cart_Fragment extends Fragment implements OnItemSwipeListener{
    ...
    public ArrayList<ProductOrderCart> listProductOrder = new ArrayList<>();
    ...
    public int getCartItemCount() {
        int cartItemCount = listProductOrder.size();
        ((MainActivity) requireActivity()).updateCartCount(cartItemCount);
